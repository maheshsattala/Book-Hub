...
class App extends Component {
  ...
  addFavorites = book => {
    ...
    //  localStorage.setItem("favorites_list", [...favoritesList, book]);
  }
  ...
  removeFavorites = id => {
    ...
    //  localStorage.setItem("favorites_list", updatedFavoritesList);
  }
...
class App extends Component {
  state = {showNavIcons: false, activeNavId: ''}
  ...
  render() {
    const {showNavIcons, activeNavId} = this.state
    return (
      <HeaderContext.Provider
        value={{
          showNavIcons,
